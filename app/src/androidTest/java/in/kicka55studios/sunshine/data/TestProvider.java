package in.kicka55studios.sunshine.data;
...
import in.kicka55studios.sunshine.data.WeatherContract.LocationEntry;
import in.kicka55studios.sunshine.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://in.kicka55studios.sunshine/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/in.kicka55studios.sunshine/weather
        ...
        // content://in.kicka55studios.sunshine/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/in.kicka55studios.sunshine/weather/1419120000
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
                WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.example.android.sunshine.app/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/in.kicka55studios.sunshine/location
